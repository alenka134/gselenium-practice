...
import com.gselenium.practice.solutions.eplay.utilites.Excel;
...
public class DataProviderExample extends BaseTest {
  ...
  /*  @DataProvider
    ...
    public Object[][] getDataFromExcel() {
        String excelPath = System.getProperty("user.dir") + "/src/main/java/com/gselenium/practice/solutions/eplay/data/input3.xls";
