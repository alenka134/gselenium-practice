...
public class HomePageTest extends BaseTest {
    ...
    @Test(priority = 2, description = "verify home page name")
    public void verifyHomepageTitle() {
        String title = driver.getTitle();
        Assert.assertEquals(title, "IPRO", "Test #2 --> Title is not matched");
        System.out.println("Test #2 --> Print Home Page title: " + title);
    }

    @Test(priority = 3, description = "verify the 1st part from Home page text")
    public void verifyHomepageText() {
        ...
        System.out.println("Test #3 --> Print Home Page text: " + text);
    }
    @Test(priority = 4, description = "verify if 4 main buttons presented on the Home screen")
    public void verifyHomepageButtons() {
        HomePage homePage = new HomePage(driver);
        Assert.assertTrue(homePage.getContactUs(),"Button is not displayed on the page");
        System.out.println("Test #4: 'Contact Us' is displayed:  --> " + homePage.getContactUs());
